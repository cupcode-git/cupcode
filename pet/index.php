<?php $title = 'agência de marketing digital para pet shops, criação de websites, artes graficas e editoriais - cupcode, inc.'; $description = 'Uma agência expert em pet shops e no mundo animal, fazemos seu investimento trabalhar por você, para que crescendo juntos, tenhamos mais resultados no agora e no futuro.'; $keywords = 'agência de marketing, pet shops, animais, petshop, digital, criação, sites, editorial, papelaria, branding'; include("../header.php"); ?>
                ...
                <div class="col-md-6 col-md-offset-6 col-sm-8 col-sm-offset-4 col-xs-12">
                        ...
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <div class="grid">
                                ...
                                <div style="display: none;" id="hidden-content-b">
                                    ...
                                    <p class="text-justify">nossa equipe é treinada para tirar o melhor das redes sociais, vamos disponibilizar seu conteúdo para quem realmente pode ser seu cliente, diminuindo custos com posts impulsionados ou patrocinados ao agirmos de forma orgânica. além da retenção e manutenção constante dos seus clientes e seguidores, utilização do Facebook Pixel e muito mais.</p>
                    ...
                    <div class="col-md-6">
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <hr>
                            <p class="text-light">anunciamos seu pet shop com inteligência, garantindo o melhor retorno de seu investimento.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-sm-8 col-xs-12">
                    ...
                    <div class="col-md-6">
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <hr>
                            <p>criamos seu site ou blog de forma responsiva e intuitiva, leve e de fácil navegação que até os clientes pets vão se interessar!</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <hr>
                            <p>temos a melhor configuração para seu pet shop ter um site confiável, estável e funcional.</p>
                        </div>
                    </div>
                    <div class="col-md-12 text-center pdt-100">
                        ...
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <div class="grid">
                                ...
                                <div style="display: none;" id="hidden-content-f">
                                    ...
                                    <p class="text-justify">quer você tenha uma logo que quer mudar ou melhorar, ou até mesmo esteja precisando de uma nova, podemos fazer logotipo, manual da marca, paleta de cores, tipografia e tudo o que você precisa para a identidade visual de seu pet shop.</p>
                                    <div class="text-center">
                        ...
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <div class="grid">
                                ...
                                <div style="display: none;" id="hidden-content-e">
                                    ...
                                    <p class="text-justify">criamos sua arte para impressão ou digital, quer você precise de um cartão de visita, flyer, folder, sacola, cardápio, comandas, publicidade para jornais e revistas,
                                    uniformes, banner, outdoor ou qualquer outra arte, com alta qualidade e design que respeita a identidade visual de seu pet shop.</p>
                                    <div class="text-center">
                            ...
                            <hr>
                            <p>fazemos todas suas lâminas para impressão ou digital, com qualidade e inteligência.</p>
                        </div>
                    </div>
                    <div class="col-md-12 text-center pdt-100">
                        ...
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <div class="grid">
                                ...
                                <div style="display: none;" id="hidden-content-h">
                                    ...
                                    <p class="text-justify">nós produziremos matérias de animais de estimação, com cuidaos, dicas e respostas a perguntas que todos se perguntam com foco em SEO para melhorar o posicionamento no raking do google e outros mecanismos de buscas na internet, para colocar seu site nas primeiras páginas das pesquisas, com conteúdo escrito por especialistas no assunto, escreveremos artigos e matérias exclusivas para seu pet shop, artigos com conteúdo relevante e específicos sobre o mundo animal.</p>
                                    <div class="text-center">
                            ...
                            <hr>
                            <p>criação de conteúdo editorial para pet shops, com foco em SEO, colocando seu site nas primeiras páginas do google.</p>
                        </div>
                    </div>
                    <div class="col-md-12 text-center pdt-100">
