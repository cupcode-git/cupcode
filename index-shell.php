            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div id="light-filters" class="cbp-l-filters dark bottom30">
                        ...
                        <div data-filter=".<?php echo $web; ?>" class="cbp-filter-item">
                            <span><?php echo $web; ?></span>
                        </div>
                        <div data-filter=".<?php echo $brading; ?>" class="cbp-filter-item">
                            <span><?php echo $branding; ?></span>
                        </div>
                        <div data-filter=".<?php echo $papelaria; ?>" class="cbp-filter-item">
                            <span><?php echo $papelaria; ?></span>
                        </div>
                    </div>
                </div>
            </div>
