                        ...
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <div class="grid">
                                ...
                                <div style="display: none;" id="hidden-content-b">
                                    ...
                                    <p class="text-justify">nossa equipe é treinada para tirar o melhor das redes sociais, vamos disponibilizar seu conteúdo para quem realmente pode ser seu consumidor, diminuindo custos com posts impulsionados ou patrocinados ao agirmos de forma orgânica. além da retenção e manutenção constante dos seus clientes e seguidores, utilização do Facebook Pixel e muito mais.</p>
                ...
                <div class="col-md-6 col-sm-8 col-xs-12">
                    ...
                    <div class="col-md-6">
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <hr>
                            <p>criamos seu site ou blog de forma responsiva e intuitiva, leve e de fácil navegação. de dar água na boca!</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <hr>
                            <p>temos a melhor configuração para seu restaurante ter um site confiável, estável e funcional.</p>
                        </div>
                    </div>
                    <div class="col-md-12 text-center pdt-100">
                        ...
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <div class="grid">
                                ...
                                <div style="display: none;" id="hidden-content-f">
                                    ...
                                    <p class="text-justify">quer você tenha uma logo que quer mudar ou melhorar, ou até mesmo esteja precisando de uma nova, podemos fazer logotipo, manual da marca, paleta de cores, tipografia e tudo o que você precisa para a identidade visual de seu restaurante.</p>
                                    <div class="text-center">
                        ...
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <div class="grid">
                                ...
                                <div style="display: none;" id="hidden-content-e">
                                    ...
                                    uniformes, banner, outdoor ou qualquer outra arte, com alta qualidade e design que respeita a identidade visual de seu restaurante.</p>
                                    <div class="text-center">
                        ...
                        <div class="icon_box equalheight top50 wow fadeInUp">
                            ...
                            <div class="grid">
                                ...
                                <div style="display: none;" id="hidden-content-h">
                                    ...
                                    <p class="text-justify">nós produziremos matérias de gastronomia e culinária com foco em SEO para melhorar o posicionamento no raking do google e outros mecanismos de buscas na internet, para colocar seu site nas primeiras páginas das pesquisas, com conteúdo escrito por especialistas no assunto, escreveremos artigos e matérias exclusivas para seu restaurante, artigos com conteúdo relevante e específicos de gastronomia do seu ramo de atividade.</p>
                                    <div class="text-center">
                            ...
                            <hr>
                            <p>criação de conteúdo editorial gastronômica, com foco em SEO, colocando seu site nas primeiras páginas do google.</p>
                        </div>
                    </div>
                    <div class="col-md-12 text-center pdt-100">
