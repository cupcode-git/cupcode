<?php $title = 'design gráfico para restaurantes - cupcode, inc.'; $description = 'Somos especialista em restaurantes, criamos artes para sua marca com todo o respeito a sua identidade visual. Não tem uma? Não tem problema, criamos ela também.'; $keywords = 'restaurantes, design, identidade visual, branding, logotipo, logo, logomarca, criação'; include("header.php"); ?>
    ...
    <div id="rev_single" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
        <ul>	<!-- slide -->
            ...
            <div class="tp-caption tp-resizeme rs-parallaxlevel-20"
                        ...
                        style="z-index: 5;border-width:0px;"><img src="images/hero-grafico-1.png" alt="Design grafico" data-ww="['650px','650px','650px','650px']" data-hh="['500px','500px','500px','500px']" width="650" height="500" data-no-retina> </div>
                <!-- layer nr. 2 -->
                <div class="tp-caption tp-resizeme rs-parallaxlevel-25"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 6;border-width:0px;"><img src="images/hero-grafico-2.png" alt="Design grafico" data-ww="['550px','550px','550px','550px']" data-hh="['471px','471px','471px','471px']" width="550" height="471" data-no-retina> </div>
                <!-- layer nr. 3 -->
                <div class="tp-caption tp-resizeme rs-parallaxlevel-10"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 7;border-width:0px;"><img src="images/hero-grafico-3.png" alt="Design grafico" data-ww="['900px','900px','900px','900px']" data-hh="['1000px','1000px','1000px','1000px']" width="900" height="1000" data-no-retina> </div>
                <!-- layer nr. 4 -->
                <div class="tp-caption tp-resizeme rs-parallaxlevel-12"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 8;border-width:0px;"><img src="images/hero-grafico-4.png" alt="Design grafico" data-ww="['200px','200px','200px','200px']" data-hh="['300px','300px','300px','300px']" width="200" height="300" data-no-retina> </div>
                <!-- layer nr. 5 -->
                <div class="tp-caption   tp-resizeme rs-parallaxlevel-11"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 9;border-width:0px;"><img src="images/hero-grafico-5.png" alt="Design grafico" data-ww="['300px','300px','300px','300px']" data-hh="['400px','400px','400px','400px']" width="300" height="400" data-no-retina> </div>
                <!-- layer nr. 8 -->
                <div class="tp-caption   tp-resizeme rs-parallaxlevel-9"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 12;border-width:0px;"><img src="images/hero-grafico-6.png" alt="Design grafico" data-ww="['730px','730px','730px','730px']" data-hh="['520px','520px','520px','520px']" width="730" height="520" data-no-retina> </div>
                <!-- layer nr. 9 -->
                <div class="tp-caption   tp-resizeme rs-parallaxlevel-11"
                        id="layers-sev"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 13;border-width:0px;"><img src="images/hero-grafico-7.png" alt="Design grafico" data-ww="['300px','300px','300px','300px']" data-hh="['500px','500px','500px','500px']" width="300" height="500" data-no-retina> </div>
                <!-- layer nr. 10 -->
                ...
                <div class="tp-caption tp-resizeme"
                        ...
                        data-paddingright="[0,0,0,0]"
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]" style="z-index: 19;"><h2 class="darkcolor">design gráfico para restaurantes</h2></div>
                <!-- layer nr. 13 -->
                <div class="tp-caption tp-resizeme"
                        id="layers-elev"
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                        ...
                        data-paddingright="[0,0,0,0]"
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]" style="z-index: 19;">Somos especialistas em design gráfico para o seu restaurante!</div>
                <!-- layer nr. 14 -->
      ...
      <div class="row">
         <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
            <div class="item-titles whitecolor text-center wow fadeInLeft">
               <h1 class="bottom25 ccdeep">criação de branding, artes gráficas impressas e digitais com foco em restaurantes</h1>
            </div>
         </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="intro-text center lightcolor1 wow fadeInUp">
                ...
                <p class="bottom15 mobilespc">construímos seu branding, de forma estratégica, criativa e com um ótimo design. sua identidade visual completa única e memorável. desde sua logo, tipografia, a palheta de cores cuidadosamente pensada para seu ramo de atividade e tudo o que você precisa para dar um up no seu restaurante.</p>
            </div>
            </div>
        </div>
    </div>
	...
	<div class="container-fluid container-padding">
		<div class="row">
			<div class="col-md-6 col-sm-9 text-left wow fadeInRight">
				...
				<p>temos um time de designers que são especialistas em criar logotipo para todos os tipos de restaurantes, tendo a certeza de que você tenha a representação da sua marca em um lindo e elegante design que começa com um estudo aprofundado sobre os conceitos, os traços, tipo de culinária, unido aos seus valores, missão e visão.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-10">
                <div class="intro-text center wow fadeInUp">
                    ...
                    <p class="bottom45 mobilespc">um dos principais meios de comunicação e divulgação de seu restaurante se encontra na papelaria, através do impresso e do digital, nosso trabalho consiste em te fazer ter uma ótima relação com os clientes, seja criando seu cartão de visitas, até suas artes para cardápios, uniformes, placas, banners, redes sociais, e-mail marketing e outras laminas que precisem da sua identidade visual.</p>
                </div>
            </div>
        </div>
    </div>
	...
	<div class="container-fluid container-padding">
		<div class="row">
			<div class="col-md-6 col-sm-9 text-left wow fadeInRight">
				...
				<p>inclui artes para impressão, como folders, flyers, panfletos, cartões de fidelidade, cartões de visita, cardápio, comandas, banners, faixas, uniforme, adesivos, imãs de geladeiras, papel timbrado, pasta, envelope e quaisquer outros itens que seja preciso enviar para impressão, nós fazemos isso por você. fechamos sua arte com as definições exigidas pelas gráficas, e garantimos que você tenha sempre o resultado esperado.</p>
	...
	<div class="container-fluid container-padding">
		<div class="row">
			...
			<div class="col-md-6 col-sm-9 text-right wow fadeInRight">
				...
				<p>no digital, faremos suas imagens para redes sociais como facebook, instagram, linkedin, whatsapp, etc. imagens de perfil, capa, posts, anúncios e tudo o que você precisar para usar no meio digital, sem precisar se preocupar em contratar um designer só para fazer isso por você.</p>
			<a href="javascript:void(0)#papelaria" class="button defaulthole top50 cc-planos scrollings">ver pacotes</a>
				</div>
			</div>
		</div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <ul class="top15">
                ...
                <li><span>tipografia</span></li>
                <li><span>palheta de cores</span></li>
                <li><span>slogan</span></li>
        ...
        <center><a href="https://api.whatsapp.com/send?phone=554133196071&amp;text=Olá,%20gostaria%20de%20solicitar%20mais%20informações%20sobre%20os%20pacotes%20de%20Design%20Gráfico%20para%20restaurantes,%20por%20favor.%20" target="_blank" class="button defaulthole mgr-10 top50"><i class="fab fa-whatsapp" aria-hidden="true"></i> tirar duvidas sobre os pacotes</a></center>
         ...
         <div class="row">
            ...
            <div class="col-md-6 col-sm-offset-3 col-sm-6 col-md-offset-0 price-table text-center top50">
               ...
               </div><p class="p-personalizado">quer um pacote para chamar de seu? criamos um pacote do seu jeito para suprir as suas necessidades. entre em contato agora mesmo e solicite uma personalização para sua loja.</p>

               
               <div class="clearfix"></div>
               
				<a href="https://api.whatsapp.com/send?phone=554133196071&amp;text=Olá,%20gostaria%20de%20montar%20um%20pacote%20design%20gráfico%20personalizado%20para%20restaurantes,%20pode%20me%20ajudar?" target="_blank" class="button contratar mgl-10 top50"><i class="fab fa-whatsapp" aria-hidden="true"></i> solicitar personalização</a>
            </div>
