        ...
        <ul>	<!-- slide -->
            ...
            <div class="tp-caption tp-resizeme rs-parallaxlevel-20"
                ...
                <div class="tp-caption tp-resizeme"
                        ...
                        data-paddingright="[0,0,0,0]"
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]" style="z-index: 19;"><h2 class="darkcolor">design gráfico para pet shops</h2></div>
                <!-- layer nr. 13 -->
                <div class="tp-caption tp-resizeme"
                        id="layers-elev"
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                        ...
                        data-paddingright="[0,0,0,0]"
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]" style="z-index: 19;">Somos especialistas em design gráfico para o seu pet shop!</div>
                <!-- layer nr. 14 -->
      ...
      <div class="row">
         <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
            <div class="item-titles whitecolor text-center wow fadeInLeft">
               <h1 class="bottom25 ccdeep">criação de branding, artes gráficas impressas e digitais com foco em pet shops</h1>
            </div>
         </div>
	...
	<div class="container-fluid container-padding">
		<div class="row">
			<div class="col-md-6 col-sm-9 text-left wow fadeInRight">
				...
				<p>temos um time de designers que são especialistas em criar logotipo para todos os tipos de pet shops, tendo a certeza de que você tenha a representação da sua marca em um lindo e elegante design que começa com um estudo aprofundado sobre os conceitos, os traços, tipo de serviços, unido aos seus valores, missão e visão.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-10">
                <div class="intro-text center wow fadeInUp">
                    ...
                    <p class="bottom45 mobilespc">um dos principais meios de comunicação e divulgação de seu pet shop se encontra na papelaria, através do impresso e do digital, nosso trabalho consiste em te fazer ter uma ótima relação com os clientes, seja criando seu cartão de visitas, até suas artes para uniformes, placas, banners, redes sociais, e-mail marketing e outras laminas que precisem da sua identidade visual.</p>
                </div>
            </div>
        </div>
    </div>
	...
	<div class="container-fluid container-padding">
		<div class="row">
			<div class="col-md-6 col-sm-9 text-left wow fadeInRight">
				...
				<p>inclui artes para impressão, como folders, flyers, panfletos, cartões de fidelidade, cartões de visita, banners, faixas, uniforme, adesivos, imãs de geladeiras, papel timbrado, pasta, envelope e quaisquer outros itens que seja preciso enviar para impressão, nós fazemos isso por você. fechamos sua arte com as definições exigidas pelas gráficas, e garantimos que você tenha sempre o resultado esperado.</p>
         ...
         <div class="row">
            ...
            <div class="col-md-6 col-sm-offset-3 col-sm-6 col-md-offset-0 price-table text-center top50">
               ...
               <div class="clearfix"></div>
				...
				<a href="https://api.whatsapp.com/send?phone=554133196071&amp;text=Olá,%20gostaria%20de%20montar%20um%20pacote%20design%20gráfico%20personalizado%20para%20pet%20shop,%20pode%20me%20ajudar?" target="_blank" class="button contratar mgl-10 top50"><i class="fab fa-whatsapp" aria-hidden="true"></i> solicitar personalização</a>
            </div>
